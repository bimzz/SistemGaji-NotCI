...
<div class="wrapper">
  ...
  <?php include 'includes/jabatan_modal.php'; ?>
</div>
...
function getRow(id){
  $.ajax({
    type: 'POST',
    url: 'daftar_jabatan.php',
    data: {id:id},
    dataType: 'json',
    success: function(response){
      $('#posid').val(response.id);
      $('#edit_title').val(response.deskripsi);
      $('#edit_rate').val(response.gaji);
      $('#del_posid').val(response.id);
      $('#del_jabatan').html(response.deskripsi);
    }
  });
}
</script>
