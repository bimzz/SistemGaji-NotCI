    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="tambah_absen.php">
                ...
                <div class="form-group">
                  	...
                  	<div class="col-sm-9">
                  		<div class="bootstrap-timepicker">
                    		<input type="text" class="form-control timepicker" id="masuk" name="masuk">
                    	</div>
                  	</div>
                </div>
                <div class="form-group">
                  	<label for="pulang" class="col-sm-3 control-label">Pulang</label>

                  	<div class="col-sm-9">
                  		<div class="bootstrap-timepicker">
                    		<input type="text" class="form-control timepicker" id="pulang" name="pulang">
                    	</div>
                  	</div>
                </div>
          	</div>
...
<div class="modal fade" id="edit">
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="edit_absen.php">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9"> 
                      <div class="date">
                        <input type="text" class="form-control" id="datepicker_edit" name="edit_tanggal">
                      </div>
                    </div>
                </div>
                <div class="form-group">
                  	<label for="edit_masuk" class="col-sm-3 control-label">Masuk</label>

                  	<div class="col-sm-9">
                  		<div class="bootstrap-timepicker">
                    		<input type="text" class="form-control timepicker" id="edit_masuk" name="edit_masuk">
                    	</div>
                  	</div>
                </div>
                <div class="form-group">
                  	<label for="edit_pulang" class="col-sm-3 control-label">Pulang</label>

                  	<div class="col-sm-9">
                  		<div class="bootstrap-timepicker">
                    		<input type="text" class="form-control timepicker" id="edit_pulang" name="edit_pulang">
                    	</div>
                  	</div>
                </div>
          	</div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	<div class="modal-header">
            	<button type="button" class="close" data-dismiss="modal" aria-label="Close">
              		<span aria-hidden="true">&times;</span></button>
            	<h4 class="modal-title"><b><span id="tanggal_absen"></span></b></h4>
          	</div>
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="hapus_absen.php">
